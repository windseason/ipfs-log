  ...
  (0, _createClass2.default)(LogIO, null, [{
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee3(ipfs, hash, _ref3) {
        var _ref3$length, length, _ref3$exclude, exclude, concurrency, sortFn, onProgressCallback, hashes, all, entries;

        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _ref3$length = _ref3.length, length = _ref3$length === void 0 ? -1 : _ref3$length, _ref3$exclude = _ref3.exclude, exclude = _ref3$exclude === void 0 ? [] : _ref3$exclude, concurrency = _ref3.concurrency, sortFn = _ref3.sortFn, onProgressCallback = _ref3.onProgressCallback;
