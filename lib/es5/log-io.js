...
var LogIO = function () {
  ...
  (0, _createClass3.default)(LogIO, null, [{
    key: 'toMultihash',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(immutabledb, log) {
        var dagNode;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (isDefined(immutabledb)) {
                  _context.next = 2;
                  break;
                }
    ...
    key: 'fromMultihash',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(immutabledb, hash) {
    ...
    key: 'fromEntry',
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(immutabledb, sourceEntries) {
        var length = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -1;
        var exclude = arguments[3];
        var onProgressCallback = arguments[4];
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 12:
                ...
                uniques = _uniques(combined, 'hash').sort(Entry.compare);
