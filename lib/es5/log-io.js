  ...
  (0, _createClass2.default)(LogIO, null, [{
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _ref2 = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : {}, _ref2$length = _ref2.length, length = _ref2$length === void 0 ? -1 : _ref2$length, exclude = _ref2.exclude, onProgressCallback = _ref2.onProgressCallback;
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee3(ipfs, hash, _ref3) {
        var _ref3$length, length, exclude, onProgressCallback, hashes, entries, sliced;

        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _ref3$length = _ref3.length, length = _ref3$length === void 0 ? -1 : _ref3$length, exclude = _ref3.exclude, onProgressCallback = _ref3.onProgressCallback;
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee5(ipfs, sourceEntries, _ref5) {
        var _ref5$length, length, exclude, onProgressCallback, hashes, entries, combined, uniques, sliced, missingSourceEntries, replaceInFront, result;

        return _regenerator.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _ref5$length = _ref5.length, length = _ref5$length === void 0 ? -1 : _ref5$length, exclude = _ref5.exclude, onProgressCallback = _ref5.onProgressCallback;
