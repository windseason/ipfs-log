...
var Entry = function () {
  ...
  (0, _createClass3.default)(Entry, null, [{
     ...
     */
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ipfs, id, data) {
        var next = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
        var clock = arguments[4];
        var signKey = arguments[5];
        var toEntry, nexts, entry;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                _context.next = 14;
                return Entry.signEntry(ipfs.keystore, entry, signKey);
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return keystore.sign(key, new Buffer((0, _stringify2.default)(entry)));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                _context3.next = 6;
                return keystore.verify(entry.sig, pubKey, new Buffer((0, _stringify2.default)(e)));
