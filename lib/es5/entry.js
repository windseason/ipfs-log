...
function () {
  ...
  (0, _createClass2.default)(Entry, null, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee(ipfs, identity, identities, logId, data) {
        var next,
            clock,
            refs,
            toEntry,
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                next = _args.length > 5 && _args[5] !== undefined ? _args[5] : [];
                clock = _args.length > 6 ? _args[6] : undefined;
                refs = _args.length > 7 && _args[7] !== undefined ? _args[7] : [];
              ...
              case 13:
                ...
                _context.next = 18;
                return identities.sign(identity, Entry.toBuffer(entry));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee2(identities, entry) {
        var validIdentity, e, verifier;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                ...
                throw new Error("".concat(entry.identity.id, " is invalid"));
              ...
              case 18:
                ...
                return _context2.abrupt("return", identities.verify(entry.sig, entry.key, Entry.toBuffer(e), verifier));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 6:
                e = _context4.sent;
                e.hash = hash;
                return _context4.abrupt("return", Entry.toEntry(e, {
                  includeHash: true
                }));
