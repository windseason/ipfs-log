...
function (_GSet) {
  ...
  (0, _createClass2.default)(Log, [{
    ...
    value: function iterator() {
      ...
      var start = lte ? [this.get(lte)] : lt ? [this.get(this.get(lt).next)] : this.heads;
      var end = gte ? this.get(gte).hash : gt ? this.get(gt).hash : null;
      var count = end ? -1 : amount || -1;
          ...
          return _regenerator.default.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.t0 = _regenerator.default.keys(entryValues);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee5(log) {
        var _this4 = this;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee6(ipfs, identity, cid) {
        var _ref5,
            access,
            _ref5$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _ref5 = _args6.length > 3 && _args6[3] !== undefined ? _args6[3] : {}, access = _ref5.access, _ref5$length = _ref5.length, length = _ref5$length === void 0 ? -1 : _ref5$length, exclude = _ref5.exclude, onProgressCallback = _ref5.onProgressCallback, sortFn = _ref5.sortFn;
                _context6.next = 3;
              ...
              case 3:
                data = _context6.sent;
                return _context6.abrupt("return", new Log(ipfs, identity, {
                  logId: data.id,
                  access: access,
                  entries: data.values,
                  heads: data.heads,
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee7(ipfs, identity, multihash) {
        var _ref6,
            access,
            _ref6$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ref6 = _args7.length > 3 && _args7[3] !== undefined ? _args7[3] : {}, access = _ref6.access, _ref6$length = _ref6.length, length = _ref6$length === void 0 ? -1 : _ref6$length, exclude = _ref6.exclude, onProgressCallback = _ref6.onProgressCallback, sortFn = _ref6.sortFn;
                return _context7.abrupt("return", Log.fromCID(ipfs, identity, multihash, {
                  access: access,
                  length: length,
                  exclude: exclude,
                  onProgressCallback: onProgressCallback,
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee8(ipfs, identity, cid, _ref7) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee9(ipfs, identity, multihash, _ref8) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                return _context9.abrupt("return", Log.fromEntryCid(ipfs, identity, multihash, {
                  logId: logId,
                  access: access,
                  length: length,
                  exclude: exclude,
        ...
        return _regenerator.default.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _ref10 = _args11.length > 3 && _args11[3] !== undefined ? _args11[3] : {}, access = _ref10.access, _ref10$length = _ref10.length, length = _ref10$length === void 0 ? -1 : _ref10$length, exclude = _ref10.exclude, onProgressCallback = _ref10.onProgressCallback, sortFn = _ref10.sortFn;
                _context11.next = 3;
