...
function (_GSet) {
   ...
   */
  function Log(ipfs, identity, identities) {
    var _this;
    ...
    if (!isDefined(identities)) {
      throw new Error('identities is required');
    }
    ...
    _this._identities = identities; // Add entries to the internal cache
    ...
    _this._clock = new Clock(_this.identity.publicKey, maxTime);
    return _this;
  }
  /**
  ...
  (0, _createClass2.default)(Log, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                identities = options.identities || this.identities; // Update the clock (find the latest clock)
                ...
                _context.next = 15;
                return Entry.create(this._storage, identity, identities, this.id, data, nexts, this.clock, refs);

              case 15:
                entry = _context.sent;
                _context.next = 18;
                return this.access.canAppend(entry);
              ...
              case 18:
                ...
                throw new Error("Could not append entry, key \"".concat(this.identity.id, "\" is not allowed to write to the log"));
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 7:
                ...
                newItems = Log.difference(log, this); // Verify if entries are allowed to be added to the log and throws if
                    ...
                    return _regenerator.default.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            _context4.next = 2;
                            return _this4.access.canAppend(entry);
                ...
                identities = this.identities; // Verify signature for each entry and throws if there's an invalid signature
                    ...
                    return _regenerator.default.wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            _context5.next = 2;
                            return Entry.verify(identities, entry);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee8(ipfs, identity, identities, hash) {
        var _ref7,
            access,
            _ref7$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _ref7 = _args8.length > 4 && _args8[4] !== undefined ? _args8[4] : {}, access = _ref7.access, _ref7$length = _ref7.length, length = _ref7$length === void 0 ? -1 : _ref7$length, _ref7$exclude = _ref7.exclude, exclude = _ref7$exclude === void 0 ? [] : _ref7$exclude, timeout = _ref7.timeout, concurrency = _ref7.concurrency, sortFn = _ref7.sortFn, onProgressCallback = _ref7.onProgressCallback;
                _context8.next = 3;
              ...
              case 3:
                ...
                heads = _ref8.heads;
                return _context8.abrupt("return", new Log(ipfs, identity, identities, {
                  logId: logId,
                  access: access,
                  entries: entries,
                  heads: heads,
      ...
      function fromMultihash(_x6, _x7, _x8, _x9) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee9(ipfs, identity, identities, hash) {
        var _ref9,
            logId,
            access,
            _ref9$length,
        ...
        return _regenerator.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _ref9 = _args9.length > 4 && _args9[4] !== undefined ? _args9[4] : {}, logId = _ref9.logId, access = _ref9.access, _ref9$length = _ref9.length, length = _ref9$length === void 0 ? -1 : _ref9$length, _ref9$exclude = _ref9.exclude, exclude = _ref9$exclude === void 0 ? [] : _ref9$exclude, timeout = _ref9.timeout, concurrency = _ref9.concurrency, sortFn = _ref9.sortFn, onProgressCallback = _ref9.onProgressCallback;
                _context9.next = 3;
              ...
              case 3:
                ...
                return _context9.abrupt("return", new Log(ipfs, identity, identities, {
                  logId: logId,
                  access: access,
                  entries: entries,
                  sortFn: sortFn
      ...
      function fromEntryHash(_x10, _x11, _x12, _x13) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee10(ipfs, identity, identities, json) {
        var _ref11,
            access,
            _ref11$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _ref11 = _args10.length > 4 && _args10[4] !== undefined ? _args10[4] : {}, access = _ref11.access, _ref11$length = _ref11.length, length = _ref11$length === void 0 ? -1 : _ref11$length, timeout = _ref11.timeout, sortFn = _ref11.sortFn, onProgressCallback = _ref11.onProgressCallback;
                _context10.next = 3;
              ...
              case 3:
                ...
                return _context10.abrupt("return", new Log(ipfs, identity, identities, {
                  logId: logId,
                  access: access,
                  entries: entries,
                  sortFn: sortFn
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee11(ipfs, identity, identities, sourceEntries) {
        var _ref13,
            access,
            _ref13$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _ref13 = _args11.length > 4 && _args11[4] !== undefined ? _args11[4] : {}, access = _ref13.access, _ref13$length = _ref13.length, length = _ref13$length === void 0 ? -1 : _ref13$length, _ref13$exclude = _ref13.exclude, exclude = _ref13$exclude === void 0 ? [] : _ref13$exclude, timeout = _ref13.timeout, concurrency = _ref13.concurrency, sortFn = _ref13.sortFn, onProgressCallback = _ref13.onProgressCallback;
                _context11.next = 3;
              ...
              case 3:
                ...
                return _context11.abrupt("return", new Log(ipfs, identity, identities, {
                  logId: logId,
                  access: access,
                  entries: entries,
                  sortFn: sortFn
