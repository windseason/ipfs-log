  ...
  (0, _createClass3.default)(Log, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(log) {
        ...
        var newItems, identityProvider, permitted, verify, entriesToJoin, addToNextsIndex, tmp, notReferencedByNewItems, notInCurrentNexts, nextsFromNewItems, mergedHeads, maxClock;
                    ...
                    return _regenerator2.default.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _context2.next = 2;
                            return _this3._access.canAppend(entry, identityProvider);
    ...
    key: 'fromMultihash',
    value: function fromMultihash(ipfs, access, identity, hash) {
    ...
    key: 'fromEntryHash',
    value: function fromEntryHash(ipfs, access, identity, hash, id) {
    ...
    key: 'fromJSON',
    value: function fromJSON(ipfs, access, identity, json) {
      var length = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : -1;
    ...
    key: 'fromEntry',
    value: function fromEntry(ipfs, access, identity, sourceEntries) {
      var length = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : -1;
      var exclude = arguments[5];
      var onProgressCallback = arguments[6];
