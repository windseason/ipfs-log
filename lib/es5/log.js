  ...
  (0, _createClass3.default)(Log, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 7;
                return Entry.create(this._storage, this.id, data, nexts, this.clock, this._key);
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(log) {
        ...
        var id = arguments[2];
        var verifyEntries, difference, newItems, canJoin, addToNextsIndex, tmp, notReferencedByNewItems, notInCurrentNexts, nextsFromNewItems, mergedHeads, maxClock, clock;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 14:
                ...
                clock = new Clock(this.id, Math.max(this.clock.time, maxClock));
