...
function (_GSet) {
   ...
   */
  function Log(ipfs, access, identity) {
    var _this;
  ...
  (0, _createClass2.default)(Log, [{
        ...
        return _regenerator.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _ref4 = _args5.length > 4 && _args5[4] !== undefined ? _args5[4] : {}, _ref4$length = _ref4.length, length = _ref4$length === void 0 ? -1 : _ref4$length, exclude = _ref4.exclude, onProgressCallback = _ref4.onProgressCallback, sortFn = _ref4.sortFn;
                _context5.next = 3;
              ...
              case 3:
                data = _context5.sent;
                return _context5.abrupt("return", new Log(ipfs, access, identity, {
                  logId: data.id,
                  entries: data.values,
                  heads: data.heads,
                  clock: data.clock,
        ...
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _ref5 = _args6.length > 4 && _args6[4] !== undefined ? _args6[4] : {}, _ref5$length = _ref5.length, length = _ref5$length === void 0 ? -1 : _ref5$length, exclude = _ref5.exclude, onProgressCallback = _ref5.onProgressCallback, sortFn = _ref5.sortFn;
                return _context6.abrupt("return", Log.fromCID(ipfs, access, identity, multihash, {
                  length: length,
                  exclude: exclude,
                  onProgressCallback: onProgressCallback,
                  sortFn: sortFn
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee7(ipfs, access, identity, cid, _ref6) {
        var logId, _ref6$length, length, exclude, onProgressCallback, sortFn, data;

        return _regenerator.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                logId = _ref6.logId, _ref6$length = _ref6.length, length = _ref6$length === void 0 ? -1 : _ref6$length, exclude = _ref6.exclude, onProgressCallback = _ref6.onProgressCallback, sortFn = _ref6.sortFn;
                _context7.next = 3;
              ...
              case 3:
                data = _context7.sent;
                return _context7.abrupt("return", new Log(ipfs, access, identity, {
                  logId: logId,
                  entries: data.values,
                  sortFn: sortFn
                }));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee8(ipfs, access, identity, multihash, _ref7) {
        var logId, _ref7$length, length, exclude, onProgressCallback, sortFn;

        return _regenerator.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                logId = _ref7.logId, _ref7$length = _ref7.length, length = _ref7$length === void 0 ? -1 : _ref7$length, exclude = _ref7.exclude, onProgressCallback = _ref7.onProgressCallback, sortFn = _ref7.sortFn;
                return _context8.abrupt("return", Log.fromEntryCid(ipfs, access, identity, multihash, {
                  logId: logId,
                  length: length,
                  exclude: exclude,
                  onProgressCallback: onProgressCallback,
        ...
        return _regenerator.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _ref8 = _args9.length > 4 && _args9[4] !== undefined ? _args9[4] : {}, _ref8$length = _ref8.length, length = _ref8$length === void 0 ? -1 : _ref8$length, timeout = _ref8.timeout, onProgressCallback = _ref8.onProgressCallback, sortFn = _ref8.sortFn;
                _context9.next = 3;
              ...
              case 3:
                data = _context9.sent;
                return _context9.abrupt("return", new Log(ipfs, access, identity, {
                  logId: data.id,
                  entries: data.values,
                  sortFn: sortFn
                }));
        ...
        return _regenerator.default.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _ref9 = _args10.length > 4 && _args10[4] !== undefined ? _args10[4] : {}, _ref9$length = _ref9.length, length = _ref9$length === void 0 ? -1 : _ref9$length, exclude = _ref9.exclude, onProgressCallback = _ref9.onProgressCallback, sortFn = _ref9.sortFn;
                _context10.next = 3;
              ...
              case 3:
                ...
                return _context10.abrupt("return", new Log(ipfs, access, identity, {
                  logId: data.id,
                  entries: data.values,
                  sortFn: sortFn
                }));
