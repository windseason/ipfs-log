...
var Log = function (_GSet) {
  ...
  (0, _createClass3.default)(Log, [{
    ...
    get: function get() {
      ...
      return (0, _values2.default)(this._entryIndex).sort(LastWriteWins);
    }
    ...
    value: function () {
      ...
      function fromMultihash(_x8, _x9, _x10, _x11) {
    ...
    value: function () {
      ...
      function fromEntryHash(_x13, _x14, _x15, _x16, _x17) {
    ...
    value: function () {
      ...
      function fromJSON(_x19, _x20, _x21, _x22) {
    ...
    value: function () {
      ...
      function fromEntry(_x24, _x25, _x26, _x27) {
