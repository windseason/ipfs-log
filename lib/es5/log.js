...
function (_GSet) {
   ...
   */
  function Log(ipfs, identity, identities, keystore) {
    var _this;
    ...
    _this._keystore = keystore; // Add entries to the internal cache
    ...
    _this._clock = new Clock(identity.publicKey, maxTime);
    return _this;
  }
  /**
  ...
  (0, _createClass2.default)(Log, [{
    ...
    value: function traverse(rootEntries) {
      ...
      while (stack.length > 0) {
        ...
        if (entry.hash === endHash) break; // Add entry's next references to the stack

        var entries = entry.next.map(getEntry);
        var defined = entries.filter(isDefined);
        defined.forEach(addToStack); // If it is the specified end hash, break out of the while loop
      }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _ref2 = _args.length > 2 && _args[2] !== undefined ? _args[2] : {}, identity = _ref2.identity, identities = _ref2.identities, keystore = _ref2.keystore;
                identity = identity || this.identity;
                identities = identities || this.identities;
                keystore = keystore || this._keystore; // Update the clock (find the latest clock)

                newTime = Math.max(this.clock.time, this.heads.reduce(maxClockTimeReducer, 0)) + 1; // this._clock = new Clock(this.clock.id, newTime)
                ...
                _context.next = 12;
                return Entry.create(this._storage, identity, identities, keystore, this.id, data, nexts, this.clock);

              case 12:
                entry = _context.sent;
                _context.next = 15;
                return this._access.canAppend(entry);
              ...
              case 15:
                ...
                throw new Error("Could not append entry, key \"".concat(identity.id, "\" is not allowed to write to the log"));

              case 18:
                _context.next = 20;
                return identities.verifyIdentity(entry.identity, keystore);

              case 20:
                verifyIdentity = _context.sent;
                ...
                throw new Error("Could not append entry, key \"".concat(identity.id, "\" could not be verified"));
    ...
    value: function iterator() {
      var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          _ref3$gt = _ref3.gt,
          gt = _ref3$gt === void 0 ? undefined : _ref3$gt,
          _ref3$gte = _ref3.gte,
          gte = _ref3$gte === void 0 ? undefined : _ref3$gte,
          _ref3$lt = _ref3.lt,
          lt = _ref3$lt === void 0 ? undefined : _ref3$lt,
          _ref3$lte = _ref3.lte,
          lte = _ref3$lte === void 0 ? undefined : _ref3$lte,
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _ref4 = _args7.length > 2 && _args7[2] !== undefined ? _args7[2] : {}, identities = _ref4.identities, keystore = _ref4.keystore;
              ...
              case 8:
                identities = identities || this.identities;
                keystore = keystore || this._keystore; // Get the difference of the logs

                newItems = Log.difference(log, this); // const identityProvider = this._identity.provider
                ...
                function () {
                  ...
                  _regenerator.default.mark(function _callee4(entry) {
                    var canAppend, verifyIdentity;
                    return _regenerator.default.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            _context4.next = 2;
                            return _this4._access.canAppend(entry);
                          ...
                          case 8:
                            ...
                            throw new Error("Could not append entry, key \"".concat(entry.identity.id, "\" could not be verified"));
                    ...
                    return _regenerator.default.wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            _context5.next = 2;
                            return Entry.verify(entry, keystore);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee8(ipfs, identity, identities, keystore, hash) {
        var _ref9,
            access,
            _ref9$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _ref9 = _args8.length > 5 && _args8[5] !== undefined ? _args8[5] : {}, access = _ref9.access, _ref9$length = _ref9.length, length = _ref9$length === void 0 ? -1 : _ref9$length, exclude = _ref9.exclude, onProgressCallback = _ref9.onProgressCallback, sortFn = _ref9.sortFn, timeout = _ref9.timeout, format = _ref9.format;
                _context8.next = 3;
              ...
              case 3:
                data = _context8.sent;
                return _context8.abrupt("return", new Log(ipfs, identity, identities, keystore, {
                  logId: data.id,
                  access: access,
                  entries: data.values,
                  heads: data.heads,
      ...
      function fromMultihash(_x6, _x7, _x8, _x9, _x10) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee9(ipfs, identity, identities, keystore, hash, _ref10) {
        var logId, access, _ref10$length, length, exclude, onProgressCallback, sortFn, timeout, data;

        return _regenerator.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                logId = _ref10.logId, access = _ref10.access, _ref10$length = _ref10.length, length = _ref10$length === void 0 ? -1 : _ref10$length, exclude = _ref10.exclude, onProgressCallback = _ref10.onProgressCallback, sortFn = _ref10.sortFn, timeout = _ref10.timeout;
                _context9.next = 3;
              ...
              case 3:
                data = _context9.sent;
                return _context9.abrupt("return", new Log(ipfs, identity, identities, keystore, {
                  logId: logId,
                  access: access,
                  entries: data.values,
                  sortFn: sortFn
      ...
      function fromEntryHash(_x11, _x12, _x13, _x14, _x15, _x16) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee10(ipfs, identity, identities, keystore, json) {
        var _ref11,
            access,
            _ref11$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _ref11 = _args10.length > 5 && _args10[5] !== undefined ? _args10[5] : {}, access = _ref11.access, _ref11$length = _ref11.length, length = _ref11$length === void 0 ? -1 : _ref11$length, timeout = _ref11.timeout, onProgressCallback = _ref11.onProgressCallback, sortFn = _ref11.sortFn;
                _context10.next = 3;
              ...
              case 3:
                ...
                return _context10.abrupt("return", new Log(ipfs, identity, identities, keystore, {
                  logId: data.id,
                  access: access,
                  entries: data.values,
                  sortFn: sortFn
      ...
      function fromJSON(_x17, _x18, _x19, _x20, _x21) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee11(ipfs, identity, identities, keystore, sourceEntries) {
        var _ref12,
            access,
            _ref12$length,
            length,
        ...
        return _regenerator.default.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _ref12 = _args11.length > 5 && _args11[5] !== undefined ? _args11[5] : {}, access = _ref12.access, _ref12$length = _ref12.length, length = _ref12$length === void 0 ? -1 : _ref12$length, exclude = _ref12.exclude, onProgressCallback = _ref12.onProgressCallback, timeout = _ref12.timeout, sortFn = _ref12.sortFn;
                _context11.next = 3;
              ...
              case 3:
                ...
                return _context11.abrupt("return", new Log(ipfs, identity, identities, keystore, {
                  logId: data.id,
                  access: access,
                  entries: data.values,
                  sortFn: sortFn
      ...
      function fromEntry(_x22, _x23, _x24, _x25, _x26) {
