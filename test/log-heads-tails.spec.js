  ...
  describe.only('Log - Heads and Tails (' + IPFS + ')', function () {
    ...
    describe('tails', () => {
      ...
      it('returns tails after loading a partial log', async () => {
        ...
        const log4 = await Log.fromEntry(ipfs, testIdentity, heads1, { length: 2 })
        ...
        assert.strictEqual(tails4[0].cid, values4[0].cid)
        assert.strictEqual(tails4[1].cid, values4[1].cid)
      })
      ...
      it('returns tails sorted by id', async () => {
        ...
        assert.strictEqual(tails4[0].clock.id, testIdentity.publicKey)
        assert.strictEqual(tails4[1].clock.id, testIdentity3.publicKey)
        assert.strictEqual(tails4[2].clock.id, testIdentity2.publicKey)
