  ...
  describe('Log - Join (' + IPFS + ')', function () {
    ...
    describe('join', () => {
      ...
      beforeEach(async () => {
        ...
        log4 = new Log(ipfs, testIdentity4, identities, keystore, { logId: 'X' })
      })
      ...
      it('joins logs', async () => {
        ...
        for (let i = 1; i <= amount; i++) {
          ...
          const n1 = await Entry.create(ipfs, testIdentity, identities, keystore, 'X', 'entryA' + i, [prev1])
          const n2 = await Entry.create(ipfs, testIdentity2, identities, keystore, 'X', 'entryB' + i, [prev2, n1])
          const n3 = await Entry.create(ipfs, testIdentity3, identities, keystore, 'X', 'entryC' + i, [prev3, n1, n2])
          items1.push(n1)
          items2.push(n2)
          items3.push(n3)
        }
        ...
        const logA = await Log.fromEntry(ipfs, testIdentity3, identities, keystore, last(items2), -1)
        ...
        const logB = await Log.fromEntry(ipfs, testIdentity3, identities, keystore, last(items3), -1)
