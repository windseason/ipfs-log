...
class LogCreator {
  static async createLogWithSixteenEntries (Log, ipfs, identityList, identities) {
    const create = async () => {
      let logA = new Log(ipfs, identityList[0], identities, { logId: 'X' })
      let logB = new Log(ipfs, identityList[1], identities, { logId: 'X' })
      let log3 = new Log(ipfs, identityList[2], identities, { logId: 'X' })
      let log = new Log(ipfs, identityList[3], identities, { logId: 'X' })
  ...
  static async createLogWithTwoHundredEntries (Log, ipfs, identityList, identities) {
    const amount = 100
